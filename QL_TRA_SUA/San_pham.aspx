<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="San_pham.aspx.cs" Inherits="QL_TRA_SUA.San_pham" %>
...
<head runat="server">
    ...
    <style>
        ...
        .control-area label { font-weight: bold; margin-right: 10px; }
        .control-area input[type="text"], .control-area select {
            padding: 8px;
            border: 1px solid #ccc;
            border-radius: 4px;
            min-width: 150px;
        }
        .control-area input[type="text"][id$="txtMoTa"] { min-width: 250px; }
        .action-button {
            padding: 10px 20px;
            border: none;
            border-radius: 5px; /* <-- ĐÃ SỬA TỪ 5mpx THÀNH 5px */
            font-weight: bold;
            cursor: pointer;
            color: white;
